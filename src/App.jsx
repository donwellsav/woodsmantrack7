  ...
  return (
    <div className="app">
      ...
      <header className="topbar">
        <button className="icon-btn sidebar-gear" onClick={() => { setShowSettings(true); setSidebarOpen(true) }} aria-label="Settings" aria-expanded={showSettings && sidebarOpen} aria-controls="settings-panel" title="Settings">
      ...
      <footer className="player">
        <div className="player-chapter">
          <button className="icon-btn" onClick={() => { setShowSettings(false); setSidebarOpen(o => !o) }} aria-label={sidebarOpen ? 'Hide chapters' : 'Show chapters'} aria-pressed={sidebarOpen}>☰</button>
